...
public extension GRActive where Base: Publisher {
    ...
    func combineWith<Output2: AnyObject, Output3: AnyObject>(_ value: Output2, _ value2: Output3) -> AnyPublisher<(Base.Output, Output2, Output3), Base.Failure> {
    ...
    func with<Output: AnyObject, Output2: AnyObject>(_ value: Output, _ value2: Output2) -> AnyPublisher<(Output, Output2), Base.Failure> {
